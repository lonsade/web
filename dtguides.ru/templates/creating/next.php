...
<div class="guide_creating" style="margin-top: 0;" data-hero="<?=$id?>">
	<div class="top">
		<div class="shot_info">
			...
			<p class="info_hero">
				<img src="/dtguides.ru/images/resources/hero/speed.png" width="53px" style="margin-left: -3px;">
				<span id="speed_bar"><?=$hero_for_guide['move_speed']?></span>
			</p>
			<p class="info_hero">
				<img src="/dtguides.ru/images/resources/hero/attack.png" width="39px" style="margin-top: 3px;">
			...
			<p class="info_hero">
				<img src="/dtguides.ru/images/resources/hero/defense.png" width="35px">
		...
		<div class="shot_info">
			...
			<p class="info_hero"<?if($hero_for_guide['type']=='сила'):?> style="color:#00bcff;"<?endif;?>>
				<img src="/dtguides.ru/images/resources/hero/strength.png">
			...
			<p class="info_hero"<?if($hero_for_guide['type']=='ловкость'):?> style="color:#00bcff;"<?endif;?>>
				<img src="/dtguides.ru/images/resources/hero/agility.png">
			...
			<p class="info_hero"<?if($hero_for_guide['type']=='интеллект'):?> style="color:#00bcff;"<?endif;?>>
				<img src="/dtguides.ru/images/resources/hero/intellect.png">
	...
	<div class="tools_for_guide accordion">
      ...
      <?foreach($skills as $skill):?>
      	...
      	<?include('hide_skill_info.inc.php');?>
      <?endforeach;?>
				<img src="/dtguides.ru/images/resources/plus_dota.png" alt="Plus">
			</div>
...
<script type="text/javascript" src="/dtguides.ru/templates/creating/creating.js"></script>