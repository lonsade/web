...
<?php
		...
		echo '<p class="no-guides">У вас нет ни одного гайда, чтобы создать его, перейдите по <a href="/dtguides.ru/creating">этой ссылке</a></p>';
	}
?>
<script type="text/javascript" src="/dtguides.ru/templates/my/js/creating.js"></script>